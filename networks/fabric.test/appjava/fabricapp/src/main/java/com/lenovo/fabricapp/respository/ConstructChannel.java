...
import com.lenovo.fabricapp.myutil.ClientHelper;
import com.lenovo.fabricapp.myutil.Config;
import com.lenovo.fabricapp.myutil.SampleOrg;
...
//	private  String FOO_CHANNEL_ID = testConfig.FOO_CHANNEL_ID;
	...
	public  void constructchannel() throws Exception {
		...
		ChannelConfiguration chainConfiguration = new ChannelConfiguration(
				new File(TEST_FIXTURES_PATH + "/blockchainkey/channel-artifacts/" + FOO_CHANNEL_NAME + ".tx"));
		...
		for (String peerName : sampleOrg.getPeerNames()) {
			...
			Properties peerProperties = testConfig.getPeerProperties(peerName, sampleOrg);// test
																					// properties
																					// for
																					// peer..
																					// if
		...
		for (String eventHubName : sampleOrg.getEventHubNames()) {
			EventHub eventHub = client.newEventHub(eventHubName, sampleOrg.getEventHubLocation(eventHubName),
					testConfig.getEventHubProperties(eventHubName, sampleOrg));
