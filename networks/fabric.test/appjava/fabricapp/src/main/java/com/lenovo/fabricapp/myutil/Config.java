 ...
 */
package com.lenovo.fabricapp.myutil;
...
public class Config {
    ...
    private static final String DEFAULT_CONFIG = "/D:/springtest/src/test/java/org/hyperledger/fabric/sdk/testutils.properties";
    private static final String ORG_HYPERLEDGER_FABRIC_SDK_CONFIGURATION = "org.hyperledger.fabric.sdktest.configuration";

    private static final String PROPBASE = "org.hyperledger.fabric.lenovo.";
    ...
    public static final String TEST_FIXTURES_PATH = "../../../fixtures";

    public static final String CHAIN_CODE_NAME = "chaincode_lenovo2";
    public static final String CHAIN_CODE_PATH = "lenovo";
    public static final String CHAIN_CODE_VERSION = "V0";
    public static final String net_work_name="lenovo";

    public static final String FOO_CHANNEL_NAME = "lenovochannel1";
...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INVOKEWAITTIME, "300000");
            defaultProperty(DEPLOYWAITTIME, "120000");
            defaultProperty(PROPOSALWAITTIME, "200000");

            //////
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.mspid", "Org1MSP");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.domname", "org1.lenovo.com");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.ca_location", "https://101.89.66.183:7054");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.caName", "ca0");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0@grpcs://101.89.66.183:7051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer0@grpcs://101.89.66.163:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0@grpcs://101.89.66.183:7053");

            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.mspid", "Org2MSP");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.domname", "org2.lenovo.com");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.ca_location", "https://101.89.66.184:7054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0@grpcs://101.89.66.184:7051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer0@grpcs://101.89.66.163:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0@grpcs://101.89.66.184:7053");

            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg3.mspid", "Org3MSP");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg3.domname", "org3.lenovo.com");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg3.ca_location", "https://10.4.4.60:7054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg3.peer_locations", "peer0@grpcs://10.4.4.61:7051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg3.orderer_locations", "orderer0@grpcs://101.89.66.163:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg3.eventhub_locations", "peer0@grpcs://10.4.4.61:7053");

            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg4.mspid", "Org4MSP");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg4.domname", "org4.lenovo.com");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg4.ca_location", "https://10.4.4.63:7054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg4.peer_locations", "peer0@grpcs://10.4.4.64:7051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg4.orderer_locations", "orderer0@grpcs://101.89.66.163:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg4.eventhub_locations", "peer0@grpcs://10.4.4.64:7053");
...
//            System.out.println("sdkProperties: " + sdkProperties);
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (runningFabricCATLS) {
                    String cert = "../../../fixtures/blockchainkey/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
    ...
    public Properties getPeerProperties(String name, SampleOrg sampleOrg) {

        return getEndPointProperties("peer", name, sampleOrg);
    ...
    private Properties getEndPointProperties(final String type, final String name, SampleOrg sampleOrg) {
        String domainName = null;
        if("orderer".equals(type)){
            domainName="lenovo.com";
        }else if("peer".equals(type)){
            domainName = getDomainName(name, sampleOrg);
        }

//        System.out.println("here:"+ name);

        String str_cert=getBlockChainKeyPath()+ "/crypto-config/ordererOrganizations".replace("orderer", type)+"/" +domainName+"/"+ type + "s/"+ name + "." + domainName + "/tls/server.crt";
    ...
    public Properties getEventHubProperties(String name, SampleOrg sampleOrg) {

        return getEndPointProperties("peer", name, sampleOrg); //uses same as named peer

    }

    public String getTestChannelPath() {

        return "/D:\\Users\\YANGTIANPENG987\\testDown\\springtest\\src/test/fixture/sdkintegration/e2e-2Orgs/channel";

    }

    public String getBlockChainKeyPath() {
        return "../../../fixtures/blockchainkey";
    }

    private String getDomainName(final String name, SampleOrg sampleOrg) {

        return sampleOrg.getDomainName();
    }
