...
public class DeployChaincode {
	...
	public void install() throws Exception {
		...
		installProposalRequest
				.setChaincodeSourceLocation(new File("../../chaincode"));
		...
		chaincodeEndorsementPolicy
				.fromYamlFile(new File( TEST_FIXTURES_PATH + "/../fabric.test/chaincode/policy/lenovo/chaincodeendorsementpolicy.yaml"));
