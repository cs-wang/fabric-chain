...
func GetOrdererAdmin(c fab.FabricClient, orgName string) (ca.User, error) {
	keyDir := "ordererOrganizations/lenovo.com/users/Admin@lenovo.com/msp/keystore"
	certDir := "ordererOrganizations/lenovo.com/users/Admin@lenovo.com/msp/signcerts"
...
func GetAdmin(c fab.FabricClient, orgPath string, orgName string) (ca.User, error) {
	keyDir := fmt.Sprintf("peerOrganizations/%s.lenovo.com/users/Admin@%s.lenovo.com/msp/keystore", orgPath, orgPath)
	certDir := fmt.Sprintf("peerOrganizations/%s.lenovo.com/users/Admin@%s.lenovo.com/msp/signcerts", orgPath, orgPath)
...
func GetUser(c fab.FabricClient, orgPath string, orgName string) (ca.User, error) {
	keyDir := fmt.Sprintf("peerOrganizations/%s.lenovo.com/users/User1@%s.lenovo.com/msp/keystore", orgPath, orgPath)
	certDir := fmt.Sprintf("peerOrganizations/%s.lenovo.com/users/User1@%s.lenovo.com/msp/signcerts", orgPath, orgPath)
